module github.com/iosmanthus/tidb-mocker

go 1.21.5

require github.com/tikv/client-go/v2 v2.0.8-0.20240123055405-3480b5ed7ce1
...
require (
	...
	github.com/tikv/pd/client v0.0.0-20231227041826-d3551ea0bdbe // indirect
